import React__default, { memo, createElement, useState, useEffect, useContext, createContext, useRef, useMemo, useCallback, createRef, Fragment, Component } from 'react';
...
function ClickableEmojiButton(_ref) {
  ...
  return createElement(Button, {
    className: cx(styles$1.emoji, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch, (_cx = {}, _cx[ClassNames.visible] = !hidden && !hiddenOnSearch, _cx), !!(hasVariations && showVariations) && styles$1.hasVariations, noBackground && styles$1.noBackground, className),
...
function EmojiCategory(_ref) {
  ...
  return createElement("li", {
    className: cx(styles$6.category, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch),
    "data-name": category,
