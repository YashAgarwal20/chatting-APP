...
function useSetConfig(config) {
  ...
  React.useEffect(function () {
    if (avoidRefresh(config, mergedConfig)) {
      return;
    }
    setMergedConfig(mergeConfig(config));
    // not gonna...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [(_config$customEmojis = config.customEmojis) == null ? void 0 : _config$customEmojis.length, config.open]);
  return mergedConfig;
}
function usePickerConfig() {
  return React.useContext(ConfigContext);
}
function avoidRefresh(prev, next) {
  var _prev$customEmojis, _next$customEmojis;
  return ((_prev$customEmojis = prev.customEmojis) == null ? void 0 : _prev$customEmojis.length) === ((_next$customEmojis = next.customEmojis) == null ? void 0 : _next$customEmojis.length) && prev.open === next.open;
}
...
function Button(props) {
  return React.createElement("button", Object.assign({
    ...
    className: flairup.cx(styles.button, props.className)
  }), props.children);
}
...
function ClickableEmojiButton(_ref) {
  ...
  return React.createElement(Button, {
    className: flairup.cx(styles$1.emoji, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch, (_cx = {}, _cx[ClassNames.visible] = !hidden && !hiddenOnSearch, _cx), !!(hasVariations && showVariations) && styles$1.hasVariations, noBackground && styles$1.noBackground, className),
...
function EmojiImg(_ref) {
  ...
  return React.createElement("img", {
    src: imgUrl,
    alt: emojiName,
    className: flairup.cx(styles$2.emojiImag, emojiStyles.external, emojiStyles.common, className),
...
function NativeEmoji(_ref) {
  ...
  return React.createElement("span", {
    className: flairup.cx(styles$3.nativeEmoji, emojiStyles.common, emojiStyles.external, className),
    "data-unified": unified,
    style: style
...
function BtnPlus() {
  ...
  return React.createElement(Button, {
    ...
    tabIndex: 0,
    className: flairup.cx(styles$4.plusSign),
    onClick: function onClick() {
      return setReactionsMode(false);
    }
  });
}
var styles$4 = /*#__PURE__*/stylesheet.create( /*#__PURE__*/_extends({
  plusSign: {
    fontSize: '20px',
    padding: '17px',
...
function Reactions() {
  ...
  return React.createElement("ul", {
    className: flairup.cx(styles$5.list, !reactionsOpen && commonStyles.hidden),
    ref: ReactionsRef
    ...
    return React.createElement("li", {
      ...
      className: flairup.cx(styles$5.emojiButton),
      noBackground: true
    }));
...
function EmojiCategory(_ref) {
  ...
  return React.createElement("li", {
    className: flairup.cx(styles$6.category, hidden && commonStyles.hidden, hiddenOnSearch && commonInteractionStyles.hiddenOnSearch),
    "data-name": category,
    "aria-label": categoryName
  }, React.createElement("h2", {
    className: flairup.cx(styles$6.label)
  }, categoryName), React.createElement("div", {
    className: flairup.cx(styles$6.categoryContent)
  }, children));
}
...
function EmojiList() {
  ...
  return React.createElement("ul", {
    className: flairup.cx(styles$7.emojiList)
...
function EmojiVariationPicker() {
  ...
  return React.createElement("div", {
    ...
    className: flairup.cx(styles$8.variationPicker, getMenuDirection() === Direction.Down && styles$8.pointingUp, visible && styles$8.visible),
    style: {
      top: top
    }
    ...
    className: flairup.cx(styles$8.pointer),
    style: pointerStyle
  }));
}
...
var styles$8 = /*#__PURE__*/stylesheet.create( /*#__PURE__*/_extends({
  variationPicker: {
...
function Body() {
  ...
  useOnMouseMove();
  return React.createElement("div", {
    className: flairup.cx(styles$9.body, commonInteractionStyles.hiddenOnReactions),
    ref: BodyRef
...
function Flex(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: flairup.cx(styles$a.flex, className, styles$a[direction])
  }, children);
}
var styles$a = /*#__PURE__*/stylesheet.create((_stylesheet$create = {
  flex: {
    display: 'flex'
  }
...
function BtnSkinToneVariation(_ref) {
  ...
  return React.createElement(Button, {
    style: style,
    onClick: onClick,
    className: flairup.cx("epr-tone-" + skinToneVariation, styles$b.tone, !isOpen && styles$b.closedTone, isActive && styles$b.active),
    tabIndex: isOpen ? 0 : -1,
...
function SkinTonePicker(_ref) {
  ...
  return React.createElement(Relative, {
    className: flairup.cx(styles$c.skinTones, vertical && styles$c.vertical, isOpen && styles$c.open, vertical && isOpen && styles$c.verticalShadow),
    style: vertical ? {
    ...
    className: flairup.cx(styles$c.select),
...
function Preview() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$d.preview, commonInteractionStyles.hiddenOnReactions)
...
function PreviewBody() {
  ...
  function PreviewContent() {
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", null, show ? React.createElement(ViewOnlyEmoji, {
      ...
      size: 45,
      getEmojiUrl: getEmojiUrl,
      className: flairup.cx(styles$d.emoji)
      ...
      className: flairup.cx(styles$d.label)
...
function CategoryButton(_ref) {
  ...
  return React.createElement(Button, {
    ...
    className: flairup.cx(styles$e.catBtn, commonInteractionStyles.categoryBtn, "epr-icn-" + category, (_cx = {}, _cx[ClassNames.active] = isActiveCategory, _cx)),
    onClick: onClick,
...
var styles$e = /*#__PURE__*/stylesheet.create( /*#__PURE__*/_extends({
  catBtn: {
    '.': 'epr-cat-btn',
...
function CategoryNavigation() {
  ...
  return React.createElement("div", {
    className: flairup.cx(styles$f.nav),
    role: "tablist",
...
var styles$f = /*#__PURE__*/stylesheet.create({
  nav: {
    '.': 'epr-category-nav',
    display: 'flex',
    flexDirection: 'row',
...
function BtnClearSearch() {
  ...
  return React.createElement(Button, {
    className: flairup.cx(styles$g.btnClearSearch, commonInteractionStyles.visibleOnSearchOnly),
    onClick: clearSearch,
    "aria-label": "Clear",
    title: "Clear"
  }, React.createElement("div", {
    className: flairup.cx(styles$g.icnClearnSearch)
  }));
}
var HoverDark = {
  ':hover': {
...
var styles$g = /*#__PURE__*/stylesheet.create( /*#__PURE__*/_extends({
  btnClearSearch: {
...
function IcnSearch() {
  return React.createElement("div", {
    className: flairup.cx(styles$h.icnSearch)
  });
}
...
function SearchContainer() {
  ...
  return React.createElement(Flex, {
    className: flairup.cx(styles$i.overlay)
...
function Search() {
  ...
  return React.createElement(Relative, {
    className: flairup.cx(styles$i.searchContainer)
    ...
    className: flairup.cx(styles$i.search),
    type: "text",
    ...
    role: "status",
    className: flairup.cx('epr-status-search-results', styles$i.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
...
function PickerRootElement(_ref2) {
  ...
  return React.createElement("aside", {
    className: flairup.cx(styles$j.main, styles$j.baseVariables, theme === exports.Theme.DARK && styles$j.darkTheme, theme === exports.Theme.AUTO && styles$j.autoThemeDark, (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx), reactionsMode && styles$j.reactionsMenu, className),
    ref: PickerMainRef,
...
var styles$j = /*#__PURE__*/stylesheet.create({
  main: {
